...
run_check python_provider_compile -- python -m py_compile beam/bin/platform-probe beam/scripts/platform_probe.py beam/scripts/run_v1_integration.py beam/scripts/build_linux_release.py beam/scripts/validate_linux_release_build_result.py beam/scripts/validate_release_manifest.py beam/tests/test_platform_probe.py beam/tests/test_runtime_integration.py beam/tests/test_release_architecture.py beam/tests/test_linux_release_builder.py beam/tests/test_linux_release_build_result.py

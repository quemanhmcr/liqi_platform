...
BASE_FILES: tuple[tuple[str, str, int, str, str], ...] = (
    ...
    ("infrastructure/systemd/liqi-platform-beam.slice", "/etc/systemd/system/liqi-platform-beam.slice", 0o644, "root", "root"),
    ("infrastructure/systemd/liqi-platform-runtime.slice", "/etc/systemd/system/liqi-platform-runtime.slice", 0o644, "root", "root"),
    ("infrastructure/systemd/liqi-platform-database.slice", "/etc/systemd/system/liqi-platform-database.slice", 0o644, "root", "root"),
    ("infrastructure/systemd/liqi-platform-edge.slice", "/etc/systemd/system/liqi-platform-edge.slice", 0o644, "root", "root"),
    ("infrastructure/systemd/liqi-platform-telemetry.slice", "/etc/systemd/system/liqi-platform-telemetry.slice", 0o644, "root", "root"),
